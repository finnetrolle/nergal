...
| [`MemoryExtractionService`](src/nergal/memory/extraction.py) | memory/extraction.py | Извлечение фактов из диалогов |
| [`should_respond_in_group()`](src/nergal/main.py:373) | main.py | Фильтрация сообщений в групповых чатах |
| [`clean_message_text()`](src/nergal/main.py:447) | main.py | Очистка @mention из текста сообщения |
