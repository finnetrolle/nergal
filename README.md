...
- 🎭 **Стили ответов** - настраиваемые стили ответов (default)
...
| `STYLE` | Стиль ответов (`default`) | `default` |
...
По умолчанию Telegram боты работают в Privacy Mode - бот получает только:
- Команды (/start, /help и т.д.)
- Сообщения где бот упомянут (@username)
- Ответы на сообщения бота
- Сообщения где бот добавлен в CC

Для работы детекции упоминаний по имени (например "Sil, привет!") **отключите Privacy Mode**:

1. Откройте [@BotFather](https://t.me/BotFather)
2. Отправьте `/mybots`
3. Выберите бота
4. Нажмите `Bot Settings` → `Group Privacy`
5. Выберите `Disable`
